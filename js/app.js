...
.pauseFor(1600)
.deleteChars(38)
.typeString('<span style="color: #FEEA9A;">Specialiste en Python et tout son écosystème</span>')
.pauseFor(1000)
.deleteChars(44)
.typeString('<span style="color: #FEEA9A;">Expert CICD</span>')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #FEEA9A;">Utiliseur de GitHub, CircleCI, Sentry et Docker</span>')
.pauseFor(1000)
.deleteChars(47)
.typeString('<span style="color: #FEEA9A;">Impliqué dans le Green IT</span></strong>')
.pauseFor(1000)
.deleteChars(25)
.typeString('<span style="color: #FEEA9A;">Securité aux normes standard OWASP</span></strong>')
.pauseFor(1000)
.deleteChars(34)
