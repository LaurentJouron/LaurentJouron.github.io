...
.pauseFor(1600)
.deleteChars(38)
.typeString('<span style="color: #FEEA9A;">Je travaille avec </span><strong><span style="color: #366C9C;"> Python et son écosystème</span></strong>')
.pauseFor(1000)
.deleteChars(24)
.typeString('<strong><span style="color: #44B78B;"> Django,</span></strong>')
.pauseFor(1000)
.typeString('<strong><span style="color: #006EBF;"> SQLAlachemy, </span></strong>')
.pauseFor(1000)
.typeString('<strong><span style="color: #A30000;"> Django RESTFramework</span></strong>')
.pauseFor(1000)
.deleteChars(67)
.typeString('<span style="color: #FEEA9A;"> Je suis Laurent Jouron, </span><strong><span style="color: #EF9700;">ANALYSTE DEVELOPPEUR</span></strong>')
.start()
